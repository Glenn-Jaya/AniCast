...
// commented out below imports b/c giving errors
/*
import simulcastBot.calendar.CalendarConnector;
import simulcastBot.calendar.Record;
import simulcastBot.calendar.Scheduling;
...
public class CalendarConnector {
	...
	public static Credential authorize() throws IOException {
		// Load client secrets.
		InputStream in = CalendarConnector.class.getResourceAsStream("/client_secret.json");
	...
	public CalendarConnector(DiscordConnector cDiscord) {
